module github.com/lack/mcmaker
...
require (
	...
	github.com/openshift/machine-config-operator v0.0.1-0.20210723001811-7cdf2e35b79a
...
require (
	...
	github.com/openshift/api v0.0.0-20210112145312-790e0a84e3e0 // indirect
